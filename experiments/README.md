...
1. `RGT/RSPSSL`: ориентированный на разделение смесей, сквозные вспомогательные функции, визуализация разделения спектров.

2. `multitaper/MoE`: экспериментальный спектральный интерфейс и сегментированный инструмент для анализа спектров.
